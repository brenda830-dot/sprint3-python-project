...
# Part a) Games with global sales > 25M
for game in video_game_sales:
    if game[GLOBAL_SALES] > 25:
        print(game[NAME], game[GLOBAL_SALES])

# Part b) Count games released before the year 2000
pre_2000_count = 0
for game in video_game_sales:
    if game[YEAR] < 2000:
...
# Part c) Calculate NA and JP sales, print totals, and compare
total_na_sales = 0
total_jp_sales = 0
...
print("North America Sales:", total_na_sales)
print("Japan Sales:", total_jp_sales)
...
# Part d) List of games published by 'Nintendo'
nintendo_games = []
for game in video_game_sales:
